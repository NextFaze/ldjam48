...
public class CharacterController2D : MonoBehaviour
{
	...
	internal void ToggleFreeze(bool freezeAll)
	{
		m_Rigidbody2D.constraints = freezeAll ? RigidbodyConstraints2D.FreezeAll : RigidbodyConstraints2D.FreezeRotation;
	}
