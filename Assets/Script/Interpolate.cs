 ...
 */
    ...
    */
     ...
     * using Catmull-Rom.
     */
	public static IEnumerator<Vector3> NewCatmullRom(Transform[] nodes, int slices, bool loop)
	{
     ...
     */
	public static IEnumerator<Vector3> NewCatmullRom(Vector3[] points, int slices, bool loop)
	{
     ...
     * function directly.
     */
	static IEnumerator<Vector3> NewCatmullRom<T>(IList nodes, ToVector3<T> toVector3, int slices, bool loop)
	{
		// need at least two nodes to spline between
		if (nodes.Count >= 2)
		{
